...
import type { AliasCreateRequest, QueueConfirmRequest } from "../shared/queue.ts";
import {
...
export function writeMatchConfirm(
	...
	return attempt<unknown>(
		() => confirmQueuedListing(itemId, body as QueueConfirmRequest),
...
export function writeAliasCreate(
	...
	return attempt<unknown>(
		() => createAlias(body as unknown as AliasCreateRequest),
		aliasCreateMutation(body),
		body,
		deps,
	);
}
