 ...
 *
 * Photographs attach to copies in `copy_photographs`. Aliases are a later ticket. Listings live
 * in their own tables further down — a field whitelist, never a raw payload.
 */
